...
from dwfcommon.utility.email.email import email_notification_job_done


@receiver(pre_save, sender=MaryJob, dispatch_uid='update_last_updated')
...
@receiver(pre_save, sender=MaryJob, dispatch_uid='notify_job_owner')
def notify_job_owner(instance, **kwargs):
    ...
    if instance.pk:
        ...
        old_instance = MaryJob.objects.get(pk=instance.pk)
