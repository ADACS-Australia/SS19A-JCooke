# Generated by Django 2.2.1 on 2019-05-13 09:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Core Member', 'Core Member'), ('Collaborator', 'Collaborator'), ('Public', 'Public')], default='Public', max_length=55, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Verification',
