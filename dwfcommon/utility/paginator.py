...
class Paginator(object):
    ...
    to write a new one because Django pagination is available for django models. We will be using the pagination here
    without any model. As a result, the necessity to have this class evolved.
    """
